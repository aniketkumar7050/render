        ...
        <>
            ...
            {/* <nav className="navbar navbar-expand-lg bg-white navbar-light shadow-sm px-5 py-3 py-lg-0">
                ...
                <div className="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <Link to="Appoint" className="btn btn-primary py-2 px-4 ms-3">Appointment</Link>
                </div>
            </nav>  */}
            {/* <!-- Navbar End -->
                            ...
                            <div className="owl-carousel price-carousel wow zoomIn" data-wow-delay="0.9s">
                                ...
                                <div className="price-item pb-4">
                                    <div className="position-relative">
                                        ...
                                        <div className="d-flex align-items-center justify-content-center bg-light rounded pt-2 px-3 position-absolute top-100 start-50 translate-middle" style={{ zIndex: '1' }}>
